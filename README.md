...
```bash
npx skills@latest add MEGA-DOT-DEV/skills
```
...
- **[remote-agent-home](./skills/remote-agent-home/SKILL.md)** — Walk a human through putting Pi sessions on an always-on host with Tailscale, Herdr, and Moshi.
